...
alias cmake_3rd_gcc='cmake -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -DCMAKE_BUILD_TYPE=Release -DCMAKE_C_FLAGS="-w" -DCMAKE_CXX_FLAGS="-w" -DCMAKE_COLOR_DIAGNOSTICS=ON -DCMAKE_INSTALL_PREFIX=~/local -DNL_JOBS=16'
...
#alias cmake_cpa="cmake -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -DCMAKE_BUILD_TYPE=Debug -DCPA_ENABLE_CLANG_FORMAT_GENERATED=ON -DCMAKE_EXE_LINKER_FLAGS='-fuse-ld=mold' -DCMAKE_COLOR_DIAGNOSTICS=ON -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DCPA_USE_LOCAL_LIB=ON -DCPA_LOCAL_PATH=/home/shylock/local"

alias cmake_nl="cmake -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++ -DCMAKE_BUILD_TYPE=Debug -DCPA_ENABLE_CLANG_FORMAT_GENERATED=ON -DCMAKE_EXE_LINKER_FLAGS='-fuse-ld=mold' -DCMAKE_CXX_FLAGS='-stdlib=libc++ -w' -DCMAKE_COLOR_DIAGNOSTICS=ON -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DCPA_USE_LOCAL_LIB=ON -DCPA_LOCAL_PATH=/home/shylock/local -DNL_USE_LOCAL_LIB=ON -DNL_LOCAL_PATH=/home/shylock/local -DBUILD_LOCAL_UI=OFF -DBESTAR_ENABLE_TESTING=ON -DBESTAR_ENABLE_SIMULATOR=ON -D3RD_PATH='~/local' -DSECS_AUTO_INSTALL_SECSC=OFF -DBESTAR_ENABLE_SECS=ON"

#alias cmake_nl="cmake -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -DCMAKE_BUILD_TYPE=Debug -DCPA_ENABLE_CLANG_FORMAT_GENERATED=ON -DCMAKE_EXE_LINKER_FLAGS='-fuse-ld=mold' -DCMAKE_COLOR_DIAGNOSTICS=ON -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DCPA_USE_LOCAL_LIB=ON -DCPA_LOCAL_PATH=/home/shylock/local -DNL_USE_LOCAL_LIB=ON -DNL_LOCAL_PATH=/home/shylock/local -DBUILD_LOCAL_UI=OFF"
...
#alias cmake_sim="cmake .. -D3RD_PATH='~/local' -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++"
